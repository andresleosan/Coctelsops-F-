...
const localEmulatorEnvironment = {
  ...
  NEXT_PUBLIC_FIREBASE_API_KEY: LOCAL_FIREBASE_CONFIG.apiKey,
  NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN: LOCAL_FIREBASE_CONFIG.authDomain,
  NEXT_PUBLIC_FIREBASE_PROJECT_ID: LOCAL_FIREBASE_CONFIG.projectId,
  NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET: LOCAL_FIREBASE_CONFIG.storageBucket,
  NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID: LOCAL_FIREBASE_CONFIG.messagingSenderId,
  NEXT_PUBLIC_FIREBASE_APP_ID: LOCAL_FIREBASE_CONFIG.appId,
