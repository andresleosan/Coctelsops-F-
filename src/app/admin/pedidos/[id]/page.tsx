...
export default function AdminOrderDetailPage() {
  ...
  async function loadOrder() {
    ...
    try {
      ...
      const found = body.orders?.find((item) => item.id === id) ?? null;
      if (!found) throw new Error("Pedido no encontrado en los últimos pedidos disponibles.");
      setOrder(found);
